// ============================================================================
// JuceColourStub.cpp - Minimal Colour implementation for audio-only build
// CueForge Qt6 - Professional show control software
// ============================================================================

#include <juce_core/juce_core.h>

// Minimal Colour class implementation - just enough for audio modules
namespace juce
{
    // Colour constructor - audio modules need this but don't use it
    Colour::Colour(uint32 argb) noexcept
        : argb(argb)
    {
    }
    ...
    // Initialize common colors used by JUCE internally
    namespace Colours
    {
        const Colour transparentBlack(0x00000000);
        ...
        const Colour darkgrey(0xffa9a9a9);
